...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        coinManager.fetchExchangeRate(currency: "USD")
    }
...
extension ViewController: UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        coinManager.fetchExchangeRate(currency: coinManager.currencyArray[row])
    }
}
...
extension ViewController: CoinManagerDelegate {
    func updateCurrencyExchange(_ coinManager: CoinManager, currencyData: CurrencyData) {
        DispatchQueue.main.async {
            self.currencyLabel.text = currencyData.currency
