...
class ViewController: UIViewController {
    ...
    var questionList = [Question(q: "A slug's blood is green.", a: "True"),
    ...
    @IBAction func answerQuestion(_ sender: UIButton) {
        ...
        if(currentQuestion < questionList.capacity){
            currentQuestion += 1
        } else {
            currentQuestion = 0
        }
    ...
    @objc func changeQuestion(){
            ...
            progressBar.progress = Float(currentQuestion+1)/Float(questionList.capacity)
        }
    }
